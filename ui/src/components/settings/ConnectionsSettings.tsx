              ...
              {isBrowserMode && (
                <div className="flex flex-col gap-2">
                  <input
                    ...
                    className="w-full text-xs bg-adj-surface border border-adj-border rounded px-2.5 py-1.5 text-adj-text-primary placeholder:text-adj-text-muted focus:outline-none focus:border-adj-accent"
                  />
                  <input
                    type="password"
